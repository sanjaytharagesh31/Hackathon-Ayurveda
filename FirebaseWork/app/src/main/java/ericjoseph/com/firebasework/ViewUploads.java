...
public class ViewUploads extends Activity {
    ...
    DatabaseReference mDatabaseReference,videoDatabaseReference,textDatabaseReference;
    Button select;
    //list to store uploads data
    List<Upload> pdfuploadList,mp4uploadList,txtuploadList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoDatabaseReference = FirebaseDatabase.getInstance().getReference("MP4 Uploads");
