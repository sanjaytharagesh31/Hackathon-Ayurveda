...
public class Main2Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    final static int PICK_MP4_CODE = 2099;
    ...
    RadioButton pdfradio, mp4radio, txtradio;
    //the firebase objects for storage and database
    StorageReference mStorageReference, videoStorageRefernce,textStorageReference;
    DatabaseReference mDatabaseReference, videoDatabaseRefernce,textDatabaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoDatabaseRefernce = FirebaseDatabase.getInstance().getReference("MP4 Uploads");
    ...
    public void getMP4() {
        ...
        startActivityForResult(Intent.createChooser(mp4, "Select MP4 File"), PICK_MP4_CODE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        } else if (requestCode == PICK_MP4_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            if (data.getData() != null)
                uploadFile(data.getData(), PICK_MP4_CODE);
            else
        ...
        if (r == PICK_PDF_CODE) {
            ...
            mp4ref.putFile(data)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            progressBar.setVisibility(View.GONE);
                            textViewStatus.setText("MP4 File Uploaded Successfully");
            ...
            txtref.putFile(data)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Upload upload = new Upload(editTextFilename.getText().toString(), taskSnapshot.getDownloadUrl().toString());
                            textDatabaseReference.child(videoDatabaseRefernce.push().getKey()).setValue(upload);
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
